...
const IzinKeluarKantorDetail = () => {
  const {colors} = useTheme();
  return (
    <View style={{flex: 1, backgroundColor: colors.background2}}>
      <Header title="Detail Izin Keluar Kantor" />
      <View style={{paddingHorizontal: 24}}>
        ...
        <View
          ...
          <View
            ...
            <View style={{flex: 1}}>
              <TextBody style={{color: colors.textTitle}} title="Approval" />
            </View>
            <View style={{flex: 1, alignItems: 'flex-end'}}>
              <Tags type="Approved" />
            </View>
...
export default IzinKeluarKantorDetail;
